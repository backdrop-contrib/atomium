...
/**
 * @file
 * The primary PHP file for the Backdrop Atomium base theme.
 *
 ...
 */
include_once backdrop_dirname(__FILE__) . '/includes/common.inc';
 ...
 */
backdrop_static_reset('element_info');

/**
 * Declare various hook_*_alter() hooks.
 *
 * Hook_*_alter() implementations must live (via include) inside this file so
 * they are properly detected when backdrop_alter() is invoked.
 */
