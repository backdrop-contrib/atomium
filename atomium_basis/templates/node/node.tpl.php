...
<article<?php print $atomium['attributes']['wrapper']; ?>>
  ...
  <?php if ($display_submitted): ?>
    <div class="submitted">
      ...
      <span class="author"><?php print t('Submitted by !name', array('!name' => render($name))); ?></span>
      <span class="date">
            <?php print t('On'); ?> <time datetime="<?php print format_date($created,
          $type = 'custom',
          $format = 'Y-m-d\TH:i:sP') ?>"><?php print $date; ?>
        </time>
      </span>
    </div>
  <?php endif; ?>
